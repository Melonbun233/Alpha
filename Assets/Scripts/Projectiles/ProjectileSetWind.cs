...
public class ProjectileSetWind : ProjectileSet
{
    // default prefab paths under Resource/ directory
    public static readonly string[] defaultPaths = {
        "Prefabs/Projectile/Projectiles/wind_level1_projectile",
        "Prefabs/Projectile/Projectiles/wind_level2_projectile",
        "Prefabs/Projectile/Projectiles/wind_level3_projectile",
